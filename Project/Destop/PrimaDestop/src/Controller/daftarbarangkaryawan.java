...
public class daftarbarangkaryawan extends javax.swing.JFrame {
...
//            rs = st.executeQuery("SELECT * FROM tbstock ORDER BY kodebarang");
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtcari, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 118, 740, 61));
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/daftarbarangkaryawan.png"))); // NOI18N
...
dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(daftarbarangkaryawan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
